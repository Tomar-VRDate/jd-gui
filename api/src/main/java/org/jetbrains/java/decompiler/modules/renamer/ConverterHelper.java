...
public class ConverterHelper
	...
	private static final Set<String> KEYWORDS                   = new HashSet<>(Arrays.asList("abstract",
	                                                                                          "do",
	                                                                                          "if",
	                                                                                          "package",
	                                                                                          "synchronized",
	                                                                                          ...
	                                                                                          "assert",
	                                                                                          "enum"));
	private static final Set<String> RESERVED_WINDOWS_NAMESPACE = new HashSet<>(Arrays.asList("con",
	                                                                                          "prn",
	                                                                                          "aux",
	                                                                                          "nul",
	                                                                                          "com1",
	...
	/**
	 * Return {@code true} if, and only if identifier passed is compliant to JLS9 section 3.8 AND DOES NOT CONTAINS
	 * so-called "ignorable" characters.
	 * Ignorable characters are removed by javac silently during compilation and thus may appear only in specially
	 * crafted obfuscated classes.
	 * For more information about "ignorable" characters see
	 * <a href="https://bugs.openjdk.java.net/browse/JDK-7144981">JDK-7144981</a>.
	 *
	 ...
	 */
	private static boolean isValidIdentifier(boolean isMethod,
	                                         String identifier) {

		assert identifier != null
						: "Null identifier passed to the isValidIdentifier() method.";
		assert !identifier.isEmpty()
						: "Empty identifier passed to the isValidIdentifier() method.";
	...
	public static String replaceSimpleClassName(String fullName,
	                                            String newName) {
		return fullName.substring(0,
		                          fullName.lastIndexOf('/') + 1) + newName;
	}

	@Override
	public boolean toBeRenamed(Type elementType,
	                           String className,
	                           String element,
	                           String descriptor) {
		...
		return value == null
		       || value.length() <= 2
		       || !isValidIdentifier(elementType == Type.ELEMENT_METHOD,
		                             value)
	...
	@Override
	public String getNextClassName(String fullName,
	                               String shortName) {
		if (shortName == null) {
	...
	@Override
	public String getNextFieldName(String className,
	                               String field,
	                               String descriptor) {
	...
	@Override
	public String getNextMethodName(String className,
	                                String method,
	                                String descriptor) {
