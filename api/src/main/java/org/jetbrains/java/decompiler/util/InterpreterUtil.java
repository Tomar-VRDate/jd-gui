...
public final class InterpreterUtil {
	...
	public static byte[] getBytes(ZipFile archive,
	                              ZipEntry entry)
					throws
					IOException {
	...
	public static void discardBytes(InputStream stream,
	                                int length)
					throws
					IOException {
	...
	public static boolean equalSets(Collection<?> c1,
	                                Collection<?> c2) {
		if (c1 == null) {
			return c2 == null;
		} else if (c2 == null) {
	...
	public static boolean equalObjects(Object first,
	                                   Object second) {
		return first == null
		       ? second == null
		       : first.equals(second);
	...
	public static boolean equalLists(List<?> first,
	                                 List<?> second) {
		if (first == null) {
			return second == null;
		} else if (second == null) {
	...
	public static String makeUniqueKey(String name,
	                                   String descriptor) {
