...
public class SingleFileSaver
	...
	public SingleFileSaver(File target) {
		...
		if (target.isDirectory()) {
			throw new IllegalStateException("Trying to save "
			                                + target.getAbsolutePath()
			                                + " as a file but there's a directory there already!");
		}
	}
	...
	public void createArchive(String path,
		...
		try {
			...
			DecompilerContext.getLogger()
			                 .writeMessage("Cannot create archive " + target,
			                               e);
		}
	}
	...
	public void closeArchive(String path,
		...
		try {
			...
			DecompilerContext.getLogger()
			                 .writeMessage("Cannot close " + target,
