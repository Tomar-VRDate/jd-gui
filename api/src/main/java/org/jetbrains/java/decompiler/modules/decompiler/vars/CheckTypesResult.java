...
public class CheckTypesResult {
	...
	public void addMaxTypeExprent(Exprent exprent,
	                              VarType type) {
		lstMaxTypeExprents.add(new ExprentTypePair(exprent,
		                                           type));
	}

	public void addMinTypeExprent(Exprent exprent,
	                              VarType type) {
		lstMinTypeExprents.add(new ExprentTypePair(exprent,
		                                           type));
	}
	...
	public static class ExprentTypePair {
		...
		public ExprentTypePair(Exprent exprent,
		                       VarType type) {
