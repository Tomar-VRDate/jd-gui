...
public class VarType {  // TODO: optimize switch
	...
	public static final VarType VARTYPE_NULL      = new VarType(CodeConstants.TYPE_NULL,
	                                                            0,
	                                                            null);
	public static final VarType VARTYPE_STRING    = new VarType(CodeConstants.TYPE_OBJECT,
	                                                            0,
	                                                            "java/lang/String");
	public static final VarType VARTYPE_CLASS     = new VarType(CodeConstants.TYPE_OBJECT,
	                                                            0,
	                                                            "java/lang/Class");
	public static final VarType VARTYPE_OBJECT    = new VarType(CodeConstants.TYPE_OBJECT,
	                                                            0,
	                                                            "java/lang/Object");
	public static final VarType VARTYPE_INTEGER   = new VarType(CodeConstants.TYPE_OBJECT,
	                                                            0,
	                                                            "java/lang/Integer");
	public static final VarType VARTYPE_CHARACTER = new VarType(CodeConstants.TYPE_OBJECT,
	                                                            0,
	                                                            "java/lang/Character");
	public static final VarType VARTYPE_BYTE_OBJ  = new VarType(CodeConstants.TYPE_OBJECT,
	                                                            0,
	                                                            "java/lang/Byte");
	public static final VarType VARTYPE_SHORT_OBJ = new VarType(CodeConstants.TYPE_OBJECT,
	                                                            0,
	                                                            "java/lang/Short");
	...
	public VarType(String signature,
		...
		this.arrayDim = arrayDim;
		this.value = value;
		this.typeFamily = getFamily(type,
		                            arrayDim);
		this.stackSize = getStackSize(type,
		                              arrayDim);
	...
	public static VarType getCommonMinType(VarType type1,
	                                       VarType type2) {
		if (type1.type == CodeConstants.TYPE_BOOLEAN && type2.type == CodeConstants.TYPE_BOOLEAN) { // special case
			// booleans
			return type1.isFalseBoolean()
			       ? type2
			       : type1;
		}
		...
		if (type1.isSuperset(type2)) {
			...
			switch (type1.typeFamily) {
				case CodeConstants.TYPE_FAMILY_INTEGER:
					if ((type1.type == CodeConstants.TYPE_CHAR && type2.type == CodeConstants.TYPE_SHORT) || (type1.type
	...
	// type1 and type2 must not be null
	public static VarType getCommonSupertype(VarType type1,
	                                         VarType type2) {
		if (type1.type == CodeConstants.TYPE_BOOLEAN && type2.type == CodeConstants.TYPE_BOOLEAN) { // special case
			// booleans
			return type1.isFalseBoolean()
		...
		if (type1.isSuperset(type2)) {
			...
			switch (type1.typeFamily) {
				case CodeConstants.TYPE_FAMILY_INTEGER:
					if ((type1.type == CodeConstants.TYPE_SHORTCHAR && type2.type == CodeConstants.TYPE_BYTE) || (type1.type
					                                                                                              == CodeConstants.TYPE_BYTE
					                                                                                              && type2.type
					                                                                                                 == CodeConstants.TYPE_SHORTCHAR)) {
	...
	public boolean equals(Object o) {
		...
		return type == vt.type && arrayDim == vt.arrayDim && InterpreterUtil.equalObjects(value,
		                                                                                  vt.value);
	}
	...
	public VarType remap(Map<VarType, VarType> map) {
		VarType key = arrayDim == 0
		              ? this
		              : this.resizeArrayDim(0);
		if (map.containsKey(key)) {
			VarType ret = map.get(key);
			return arrayDim == 0 || ret == null
			       ? ret
			       : ret.resizeArrayDim(ret.arrayDim + arrayDim);
		}
		return this;
	}
}
