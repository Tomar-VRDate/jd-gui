...
public class RootStatement
	...
	public RootStatement(Statement head,
	...
	public TextBuffer toJava(int indent) {
		return ExprProcessor.listToJava(varDefinitions,
		                                indent)
		                    .append(first.toJava(indent));
	}
	...
	public StartEndPair getStartEndRange() {
		return StartEndPair.join(first.getStartEndRange(),
		                         dummyExit != null
