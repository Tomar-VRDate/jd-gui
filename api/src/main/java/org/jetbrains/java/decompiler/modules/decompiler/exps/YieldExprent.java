...
public class YieldExprent
	...
	public YieldExprent(Exprent content,
	                    VarType retType) {
		super(EXPRENT_YIELD);
	...
	@Override
	public Exprent copy() {
		return new YieldExprent(this.content.copy(),
		                        this.retType);
	}
	...
	public CheckTypesResult checkExprTypeBounds() {
		...
		if (retType.type != CodeConstants.TYPE_VOID) {
			result.addMinTypeExprent(this.content,
			                         VarType.getMinTypeInFamily(retType.typeFamily));
			result.addMaxTypeExprent(this.content,
			                         retType);
		}
	...
	public TextBuffer toJava(int indent) {
		...
		buf.append("yield ");
		ExprProcessor.getCastedExprent(this.content,
		                               this.retType,
		                               buf,
		                               indent,
		                               false,
