...
public class ArrayExprent
	...
	public ArrayExprent(Exprent array,
	                    Exprent index,
	                    VarType hardType,
	...
	@Override
	public Exprent copy() {
		return new ArrayExprent(array.copy(),
		                        index.copy(),
		                        hardType,
		                        bytecode);
	}
	...
	public CheckTypesResult checkExprTypeBounds() {
		...
		result.addMinTypeExprent(index,
		                         VarType.VARTYPE_BYTECHAR);
		result.addMaxTypeExprent(index,
		                         VarType.VARTYPE_INT);
		return result;
	}
	...
	public boolean equals(Object o) {
		...
		return InterpreterUtil.equalObjects(array,
		                                    arr.getArray()) && InterpreterUtil.equalObjects(index,
		                                                                                    arr.getIndex());
	}
