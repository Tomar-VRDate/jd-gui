...
public interface API {
	...
	<T extends JComponent & UriGettable> void addPanel(String title,
	                                                   Icon icon,
	                                                   String tip,
	                                                   T component);

	Collection<Action> getContextualActions(Container.Entry entry,
	                                        String fragment);
	...
	void loadSource(Container.Entry entry,
