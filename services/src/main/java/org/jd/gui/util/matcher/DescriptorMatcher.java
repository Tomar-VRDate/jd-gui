...
public class DescriptorMatcher {
	...
	public static boolean matchFieldDescriptors(String d1,
	                                            String d2) {
		return matchDescriptors(new CharBuffer(d1),
		                        new CharBuffer(d2));
	}

	protected static boolean matchDescriptors(CharBuffer cb1,
	                                          CharBuffer cb2) {
		if (cb1.read() == '?') {
			if (cb2.read() == '?') {
				return true;
	...
	public static boolean matchMethodDescriptors(String d1,
	                                             String d2) {
