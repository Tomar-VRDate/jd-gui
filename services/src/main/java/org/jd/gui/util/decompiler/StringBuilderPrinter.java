...
public class StringBuilderPrinter
	...
	@Override
	public void printText(String text) {escape(text);}

	@Override
	public void printNumericConstant(String constant) {escape(constant);}

	@Override
	public void printStringConstant(String constant,
	                                String ownerInternalName) {escape(constant);}

	@Override
	public void printKeyword(String keyword) {stringBuffer.append(keyword);}

	@Override
	public void printDeclaration(int type,
	                             String internalTypeName,
	                             String name,
	                             String descriptor) {escape(name);}
	...
	public void printReference(int type,
	                           ...
	                           String name,
	                           String descriptor,
	                           String ownerInternalName) {escape(name);}

	@Override
	public void indent() {indentationCount++;}
	...
	@Override
	public void endLine() {stringBuffer.append(NEWLINE);}
