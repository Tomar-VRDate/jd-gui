...
public class EjbJarXmlFilePage
				extends TypeReferencePage
				implements UriGettable,
				           IndexesChangeListener {
	public static final List<String>                typeHyperlinkPaths        = Arrays.asList("ejb-jar/assembly"
	...
	public EjbJarXmlFilePage(API api,
