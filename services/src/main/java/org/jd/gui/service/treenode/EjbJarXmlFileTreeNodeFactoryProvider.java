...
public class EjbJarXmlFileTreeNodeFactoryProvider
				extends FileTreeNodeFactoryProvider {
	protected static final ImageIcon ICON = new ImageIcon(ManifestFileTreeNodeFactoryProvider.class.getClassLoader()
	                                                                                               .getResource("org/jd"
	                                                                                                            + "/gui"
	                                                                                                            +
	                                                                                                            "/images"
	...
	@Override
	public String[] getSelectors() {return appendSelectors("jar:file:META-INF/ejb-jar.xml");}
	...
	protected static class TreeNode
		...
		public <T extends JComponent & UriGettable> T createPage(API api) {
			return (T) new EjbJarXmlFilePage(api,
			                                 entry);
		}
	}
}
