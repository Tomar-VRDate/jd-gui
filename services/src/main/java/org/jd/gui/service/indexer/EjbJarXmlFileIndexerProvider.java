...
public class EjbJarXmlFileIndexerProvider
	...
	public void index(API api,
		...
		new EjbJarXmlPathFinder(entry,
		                        indexes).find(TextReader.getText(entry.getInputStream()));
	}
	...
	public static class EjbJarXmlPathFinder
		...
		public EjbJarXmlPathFinder(Container.Entry entry,
		                           Indexes indexes) {
			super(Arrays.asList("ejb-jar/assembly-descriptor/application-exception/exception-class",
			                    ...
			                    "ejb-jar/enterprise-beans/message-driven/resource-ref/injection-target/injection-target"
			                    + "-class",
			                    "ejb-jar/enterprise-beans/message-driven/resource-env-ref/injection-target/injection-target"
			                    + "-class",
