...
public class WebXmlFileTreeNodeFactoryProvider
	...
	@Override
	public String[] getSelectors() {return appendSelectors("war:file:WEB-INF/web.xml");}
	...
	protected static class TreeNode
		...
		public <T extends JComponent & UriGettable> T createPage(API api) {
			return (T) new WebXmlFilePage(api,
			                              entry);
		}
	}
}
