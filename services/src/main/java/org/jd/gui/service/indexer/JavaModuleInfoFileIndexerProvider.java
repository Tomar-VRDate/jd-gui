...
public class JavaModuleInfoFileIndexerProvider
	...
	public void index(API api,
		...
		try (InputStream inputStream = entry.getInputStream()) {
			...
			addToIndexes(indexes,
			             ...
			             javaModuleDeclarationSet,
			             entry);
			addToIndexes(indexes,
			             "javaModuleReferences",
			             javaModuleReferenceSet,
			             entry);
			addToIndexes(indexes,
			             "typeReferences",
			             typeReferenceSet,
	...
	protected class ClassIndexer
		...
		@Override
		public ModuleVisitor visitModule(String moduleName,
		                                 int moduleFlags,
	...
	protected class ModuleIndexer
		...
		public void visitRequire(final String module,
		                         final int access,
		                         final String version) {javaModuleReferenceSet.add(module);}
