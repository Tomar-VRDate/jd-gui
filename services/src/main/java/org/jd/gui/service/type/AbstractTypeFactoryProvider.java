...
public abstract class AbstractTypeFactoryProvider
	...
	protected static final ImageIcon    ABSTRACT_OVERLAY_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/abstract_ovr.png"));
	protected static final ImageIcon    FINAL_OVERLAY_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/final_ovr.png"));
	protected static final ImageIcon    STATIC_OVERLAY_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/static_ovr.png"));
	protected static final ImageIcon    CLASS_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/class_default_obj.png"));
	protected static final ImageIcon    PUBLIC_CLASS_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/class_obj.png"));
	protected static final ImageIcon    PROTECTED_CLASS_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/class_protected_obj.png"));
	protected static final ImageIcon    PRIVATE_CLASS_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/class_private_obj.png"));
	protected static final ImageIcon    INTERFACE_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/int_default_obj.png"));
	protected static final ImageIcon    PUBLIC_INTERFACE_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/int_obj.png"));
	protected static final ImageIcon    PROTECTED_INTERFACE_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/int_protected_obj.png"));
	protected static final ImageIcon    PRIVATE_INTERFACE_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/int_private_obj.png"));
	protected static final ImageIcon    ANNOTATION_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/annotation_obj.png"));
	protected static final ImageIcon    ENUM_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/enum_obj.png"));
	protected static final ImageIcon    FIELD_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/field_default_obj.png"));
	protected static final ImageIcon    PUBLIC_FIELD_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/field_public_obj.png"));
	protected static final ImageIcon    PROTECTED_FIELD_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/field_protected_obj.png"));
	protected static final ImageIcon    PRIVATE_FIELD_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/field_private_obj.png"));
	protected static final ImageIcon    METHOD_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/methdef_obj.png"));
	protected static final ImageIcon    PUBLIC_METHOD_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/methpub_obj.png"));
	protected static final ImageIcon    PROTECTED_METHOD_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/methpro_obj.png"));
	protected static final ImageIcon    PRIVATE_METHOD_ICON
					                                                         =
					new ImageIcon(ClassFileTypeFactoryProvider.class.getClassLoader()
					                                                                                                           .getResource("org/jd/gui/images/methpri_obj.png"));
	// Default icon set
	protected static final ImageIcon[]  DEFAULT_CLASS_ICONS          = {CLASS_ICON,
	                                                                    PUBLIC_CLASS_ICON,
	                                                                    PROTECTED_CLASS_ICON,
	                                                                    PRIVATE_CLASS_ICON};
	// Add static icon set
	protected static final ImageIcon[]  STATIC_CLASS_ICONS           = mergeIcons(DEFAULT_CLASS_ICONS,
	                                                                              STATIC_OVERLAY_ICON,
	                                                                              100,
	                                                                              0);
	// Add final icon set
	protected static final ImageIcon[]  FINAL_STATIC_CLASS_ICONS     = mergeIcons(STATIC_CLASS_ICONS,
	                                                                              FINAL_OVERLAY_ICON,
	                                                                              0,
	                                                                              0);
	// Add abstract icon set
	protected static final ImageIcon[]  CLASS_ICONS                  = mergeIcons(FINAL_STATIC_CLASS_ICONS,
	                                                                              ABSTRACT_OVERLAY_ICON,
	                                                                              0,
	                                                                              100);
	protected static final ImageIcon[]  DEFAULT_INTERFACE_ICONS      = {INTERFACE_ICON,
	                                                                    PUBLIC_INTERFACE_ICON,
	                                                                    PROTECTED_INTERFACE_ICON,
	                                                                    PRIVATE_INTERFACE_ICON};
	protected static final ImageIcon[]  STATIC_INTERFACE_ICONS       = mergeIcons(DEFAULT_INTERFACE_ICONS,
	                                                                              STATIC_OVERLAY_ICON,
	                                                                              100,
	                                                                              0);
	protected static final ImageIcon[]  FINAL_STATIC_INTERFACE_ICONS = mergeIcons(STATIC_INTERFACE_ICONS,
	                                                                              FINAL_OVERLAY_ICON,
	                                                                              0,
	                                                                              0);
	protected static final ImageIcon[]  INTERFACE_ICONS              = mergeIcons(FINAL_STATIC_INTERFACE_ICONS,
	                                                                              ABSTRACT_OVERLAY_ICON,
	                                                                              0,
	                                                                              100);
	protected static final ImageIcon[]  DEFAULT_FIELD_ICONS          = {FIELD_ICON,
	                                                                    PUBLIC_FIELD_ICON,
	                                                                    PROTECTED_FIELD_ICON,
	                                                                    PRIVATE_FIELD_ICON};
	protected static final ImageIcon[]  STATIC_FIELD_ICONS           = mergeIcons(DEFAULT_FIELD_ICONS,
	                                                                              STATIC_OVERLAY_ICON,
	                                                                              100,
	                                                                              0);
	protected static final ImageIcon[]  FINAL_STATIC_FIELD_ICONS     = mergeIcons(STATIC_FIELD_ICONS,
	                                                                              FINAL_OVERLAY_ICON,
	                                                                              0,
	                                                                              0);
	protected static final ImageIcon[]  FIELD_ICONS                  = mergeIcons(FINAL_STATIC_FIELD_ICONS,
	                                                                              ABSTRACT_OVERLAY_ICON,
	                                                                              0,
	                                                                              100);
	protected static final ImageIcon[]  DEFAULT_METHOD_ICONS         = {METHOD_ICON,
	                                                                    PUBLIC_METHOD_ICON,
	                                                                    PROTECTED_METHOD_ICON,
	                                                                    PRIVATE_METHOD_ICON};
	protected static final ImageIcon[]  STATIC_METHOD_ICONS          = mergeIcons(DEFAULT_METHOD_ICONS,
	                                                                              STATIC_OVERLAY_ICON,
	                                                                              100,
	                                                                              0);
	protected static final ImageIcon[]  FINAL_STATIC_METHOD_ICONS    = mergeIcons(STATIC_METHOD_ICONS,
	                                                                              FINAL_OVERLAY_ICON,
	                                                                              0,
	                                                                              0);
	protected static final ImageIcon[]  METHOD_ICONS                 = mergeIcons(FINAL_STATIC_METHOD_ICONS,
	                                                                              ABSTRACT_OVERLAY_ICON,
	                                                                              0,
	                                                                              100);
	...
	public AbstractTypeFactoryProvider() {
		...
		try (InputStream is = clazz.getClassLoader()
		                           .getResourceAsStream(clazz.getName()
		                                                     .replace('.',
		                                                              '/') + ".properties")) {
			if (is != null) {
				properties.load(is);
	...
	// Signature writers
	protected static int writeSignature(StringBuilder sb,
	                                    String descriptor,
	                                    int length,
	                                    int index,
	                                    boolean varargsFlag) {
		while (true) {
			...
			switch (descriptor.charAt(index)) {
				...
				case '.':
					...
					String internalClassName = descriptor.substring(beginIndex,
					                                                index);
				...
				case 'T':
					beginIndex = ++index;
					index = descriptor.substring(beginIndex,
					                             length)
					                  .indexOf(';');
	...
	protected static void writeMethodSignature(StringBuilder sb,
	                                           int typeAccess,
	                                           int methodAccess,
	...
	protected static ImageIcon mergeIcons(ImageIcon background,
	                                      ImageIcon overlay,
	                                      int x,
	                                      int y) {
	...
	protected static ImageIcon[] mergeIcons(ImageIcon[] backgrounds,
	                                        ImageIcon overlay,
	                                        int x,
	                                        int y) {
		...
		for (int i = 0;
		     i < length;
		     i++) {
			result[length + i] = mergeIcons(backgrounds[i],
			                                overlay,
			                                x,
			                                y);
		}
	...
	protected void init(Properties properties) {
		...
		externalSelectors = (selectors == null)
		                    ? null
		                    : Arrays.asList(selectors.split(","));

		String pathRegExp = properties.getProperty("pathRegExp");
		externalPathPattern = (pathRegExp == null)
		                      ? null
		                      : Pattern.compile(pathRegExp);
	}
