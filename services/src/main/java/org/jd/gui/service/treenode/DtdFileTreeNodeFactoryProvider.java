...
public class DtdFileTreeNodeFactoryProvider
				extends TextFileTreeNodeFactoryProvider {
	protected static final ImageIcon ICON = new ImageIcon(DtdFileTreeNodeFactoryProvider.class.getClassLoader()
	...
	@Override
	public String[] getSelectors() {return appendSelectors("*:file:*.dtd");}
	...
	protected static class TreeNode
		...
		public <T extends JComponent & UriGettable> T createPage(API api) {
			return (T) new TextFileTreeNodeFactoryProvider.Page(entry) {
				@Override
				public String getSyntaxStyle() {return SyntaxConstants.SYNTAX_STYLE_DTD;}
			};
		}
	}
}
