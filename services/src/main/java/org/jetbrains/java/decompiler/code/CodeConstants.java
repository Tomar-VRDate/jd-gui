...
public interface CodeConstants {
	...
	static boolean isSignaturePolymorphic(String classname,
	                                      String name,
	                                      boolean checkReturn) {
	...
	static boolean isReturnPolymorphic(String classname,
	                                   String name) {
		return isSignaturePolymorphic(classname,
		                              name,
		                              true);
	}

	static boolean areParametersPolymorphic(String classname,
	                                        String name) {
		return isSignaturePolymorphic(classname,
		                              name,
		                              false);
	...
	class SignaturePolymorphic {
		...
		static Set<String> VAR_HANDLE_RETURN_POLYMORPHIC = new HashSet<>(Arrays.asList("get",
		                                                                               "getVolatile",
		                                                                               "getOpaque",
		                                                                               "getAcquire"));

		// methods returning void or boolean
		static Set<String> VAR_HANDLE_PARAMETER_POLYMORPHIC = new HashSet<>(Arrays.asList("set",
		                                                                                  "setVolatile",
		                                                                                  "setOpaque",
		                                                                                  "setRelease",
		                                                                                  "compareAndSet",
		...
		static {
			String[] base = {"compareAndExchange",
			                 "getAndSet",
			                 "getAndAdd",
			                 "getAndBitwiseOr",
			                 "getAndBitwiseAnd",
