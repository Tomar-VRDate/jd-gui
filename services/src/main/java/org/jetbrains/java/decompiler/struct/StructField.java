...
public class StructField
	...
	protected StructField(int accessFlags,
	...
	protected StructField(int accessFlags,
	                      ...
	                      String name,
	                      String descriptor,
	                      GenericFieldDescriptor signature,
	                      BytecodeVersion version) {
		super(accessFlags,
		      attributes);
		this.name = name;
	...
	public static StructField create(DataInputFullStream in,
	                                 ConstantPool pool,
		...
		String[] values = pool.getClassElement(ConstantPool.FIELD,
		                                       clQualifiedName,
		                                       nameIndex,
		                                       descriptorIndex);
		...
		return new StructField(accessFlags,
		                       attributes,
		                       values[0],
		                       values[1],
		                       signature,
