...
public class Instruction
	...
	public static Instruction create(int opcode,
		...
		if (opcode >= opc_ifeq && opcode <= opc_if_acmpne
			...
			return new SwitchInstruction(opcode,
			                             group,
			                             wide,
			                             bytecodeVersion,
			                             operands,
	...
	public static boolean equals(Instruction i1,
	                             Instruction i2) {
	...
	public String toString() {
		...
		res.append("@")
		   .append(TextUtil.getInstructionName(opcode));
