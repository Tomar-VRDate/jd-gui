...
public class SwitchHeadExprent
	...
	public SwitchHeadExprent(Exprent value,
	...
	@Override
	public Exprent copy() {
		SwitchHeadExprent swExpr = new SwitchHeadExprent(value.copy(),
		                                                 bytecode);
			...
			for (Exprent expr : lst) {
				if (expr != null) {
					...
					if (!caseType.equals(valType)) {
						valType = VarType.getCommonSupertype(caseType,
						                                     valType);
						result.addMinTypeExprent(value,
						                         valType);
					}
	...
	public TextBuffer toJava(int indent) {
		TextBuffer buf = value.toJava(indent)
		                      .enclose("switch(",
		                               ")");
	...
	public boolean equals(Object o) {
		...
		return InterpreterUtil.equalObjects(value,
		                                    sw.getValue());
	}
