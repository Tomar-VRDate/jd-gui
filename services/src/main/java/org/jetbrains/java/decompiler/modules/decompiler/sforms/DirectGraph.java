...
public class DirectGraph {
	...
	public final VBStyleCollection<DirectNode, String>     nodes                               =
					new VBStyleCollection<>();
	...
	private static void addToReversePostOrderListIterative(DirectNode root,
	                                                       List<? super DirectNode> lst) {
