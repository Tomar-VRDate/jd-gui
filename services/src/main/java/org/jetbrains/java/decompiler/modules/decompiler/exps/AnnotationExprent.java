...
public class AnnotationExprent
	...
	public AnnotationExprent(String className,
	                         List<String> parNames,
	                         List<? extends Exprent> parValues) {
	...
	public Exprent copy() {
		...
		return new AnnotationExprent(className,
		                             parNames,
		                             exps);
	}
	...
	public boolean equals(Object o) {
		...
		return className.equals(ann.className)
		       && InterpreterUtil.equalLists(parNames,
		                                     ann.parNames)
		       && InterpreterUtil.equalLists(parValues,
		                                     ann.parValues);
	}
