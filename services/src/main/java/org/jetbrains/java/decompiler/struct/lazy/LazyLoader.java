...
public class LazyLoader {
	...
	public void addClassLink(String className,
	                         Link link) {
		mapClassLinks.put(className,
		                  link);
	}
	...
	public byte[] getClassBytes(String externalPath,
	                            String internalPath)
					throws
					IOException {
		return provider.getBytecode(externalPath,
		                            internalPath);
	}

	public DataInputFullStream getClassStream(String externalPath,
	                                          String internalPath)
					throws
					IOException {
		return new DataInputFullStream(getClassBytes(externalPath,
		                                             internalPath));
	}

	public DataInputFullStream getClassStream(String qualifiedClassName)
					throws
					IOException {
		...
		return link == null
		       ? null
		       : link.data != null
		         ? new DataInputFullStream(link.data)
		         : getClassStream(link.externalPath,
		                          link.internalPath);
	}
	...
	public static class Link {
		...
		public Link(String externalPath,
		            String internalPath) {
			this(externalPath,
			     internalPath,
			     null);
